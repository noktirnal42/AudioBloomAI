...
public actor AudioBridge: ObservableObject {
    ...
    public enum AudioBridgeError: Error, CustomStringConvertible, Sendable {
        ...
        public var description: String {
            ...
            case .notReady:
                return "Audio bridge is not ready for processing"
            }
        }
    }
    ...
    /// Publisher for visualization data with MainActor isolation
    @MainActor private let visualizationSubject = PassthroughSubject<VisualizationData, Never>()
